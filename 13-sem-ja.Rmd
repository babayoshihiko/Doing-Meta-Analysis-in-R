...
```{r metasem_forest_img, message = F, out.width = '70%', echo = F, fig.align='center', eval = FALSE}
library(OpenImageR)  # This code chunk is not evaluated in Japanese version.
...
```{r, fig.align="center", fig.width=4, fig.height=3, out.width="60%"}
# macOS 用文字化け対策
...
```{r cfa_img, message = F, out.width = '65%', echo = F, fig.align='center', eval = FALSE}
library(OpenImageR)  # This code chunk is not evaluated in Japanese version.
...
**問題の解答は、本書の巻末 [Appendix A](https://bookdown.org/baba_yoshihiko/Doing_Meta_Analysis_in_R/qanda.html#qanda11) にある。**
