...
post hoc に検出力を解釈すると、**power approach paradox**  (PAP) にもつながる。有意な効果をもたらさない分析では、p 値が**小さい**と、帰無仮説が真であるという**より多くの**証拠を示し、真の効果を検出する力が**高く**なると考えられるため、このパラドックスが生じる。<!-- needs more explanation-->
