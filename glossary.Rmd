...
\index{Meta-Regression}\index{メタ回帰}
...
\index{PRISMA Statement}\index{PRISMA 声明}
\index{Campbell Collaboration}
\index{Risk of Bias}\index{バイアスのリスク}
\index{Cochrane, Risk of Bias Tool}
\index{Risk of Bias}\index{バイアスのリスク}\index{バイアスリスク}
...
\index{Analysis Plan}\index{解析計画}
\index{Permutation}
\index{Multi-Collinearity}\index{多重共線性}
\index{Overfitting}
